...
<form id="frmInfhosp" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="frmInfhosp" 
        oninput="">
    ...
    <div class="container">
        ...
        <div>
		        ...
		        <label for="tab-4" class="tab-label-4">Formato 4</label>
