    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>              
                ...
                <td>Categoria CP:</td>
                <td>
                    <?php echo $this->lists['Centros'];?>
                </td>
            </tr>
            <tr>              
                <td>Nucleo Urbano:</td>
                <td>
                    <input class="text_area" type="text" name="tx_nucleo_urbano" id="tx_nucleo_urbano" size="25" maxlength="250" value="<?php echo $this->familia->tx_nucleo_urbano; ?>" />
                </td>
                <td>Categoria NU:</td>
                <td>
                    <?php echo $this->lists['Nucleos'];?>
                </td>
            </tr>
            <tr>              
                <td colspan="2">&nbsp;</td>
            ...
            <tr>              
                ...
                <td>Nombre de via:</td>
                <td>
                    <input class="text_area" type="text" name="tx_nombre_via" id="tx_nombre_via" size="25" maxlength="250" value="<?php echo $this->familia->tx_nombre_via; ?>" />
                </td>
            </tr>
            <tr>              
                <td colspan="2">&nbsp;</td>
                <td>N. Puerta:</td>
                <td>
                    <input class="text_area" type="text" name="un_puerta" id="un_puerta" size="15" value="<?php echo $this->familia->un_puerta; ?>" />
                </td>
            </tr>
            <tr>              
                <td colspan="2">&nbsp;</td>
                <td>Piso:</td>
                <td>
                    <input class="text_area" type="text" name="un_piso" id="un_piso" size="15" value="<?php echo $this->familia->un_piso; ?>" />
                </td>
            </tr>
            <tr>              
                <td>Zona N.:</td>
                <td>
                    <input class="text_area" type="text" name="tx_zona" id="tx_zona" size="15" maxlength="250" value="<?php echo $this->familia->tx_zona; ?>" />
                </td>
                <td>Interior:</td>
                <td>
                    <input class="text_area" type="text" name="un_interior" id="un_interior" size="15" maxlength="250" value="<?php echo $this->familia->un_interior; ?>" />
                </td>
            </tr>
            <tr>              
                <td>Manzana:</td>
                <td>
                    <input class="text_area" type="text" name="tx_manzana" id="tx_manzana" size="15" maxlength="250" value="<?php echo $this->familia->tx_manzana; ?>" />
                </td>
                <td>Manzana:</td>
                <td>
                    <input class="text_area" type="text" name="tx_manzana_nucleo" id="tx_manzana_nucleo" size="15" maxlength="250" value="<?php echo $this->familia->tx_manzana_nucleo; ?>" />
                </td>
            </tr>
            <tr>              
                <td>Vivienda N.:</td>
                <td>
                    <input class="text_area" type="text" name="un_vivienda" id="un_vivienda" size="15" maxlength="250" value="<?php echo $this->familia->un_vivienda; ?>" />
                </td>
                <td>Lote:</td>
                <td>
                    <input class="text_area" type="text" name="tx_lote" id="tx_lote" size="15" maxlength="250" value="<?php echo $this->familia->tx_lote; ?>" />
                </td>
            </tr>
            <tr>              
                <td>N. Hogares:</td>
                <td>
                    <input class="text_area" type="text" name="un_hogares" id="un_hogares" size="3" maxlength="2" value="<?php echo $this->familia->un_hogares; ?>" />
                </td>
                <td>Km.:</td>
                <td>
                    <input class="text_area" type="text" name="un_km" id="un_km" size="15" value="<?php echo $this->familia->un_km; ?>" />
                </td>
            </tr>
            <tr>              
                <td>Hogar:</td>
                <td>
                    <input class="text_area" type="text" name="un_hogar" id="un_hogar" size="3" maxlength="2" value="<?php echo $this->familia->un_hogar; ?>" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
